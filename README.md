...
## Flowchart
(Employee Flowchart)
![Employee Flowchart](employeeflowchart.png)
(Manager Flowchart)
![Manager Flowchart](managerflowchart.png)
...
IF authenticated THEN
   Authorize user
IF  Authorized THEN 
 Show vts home page and return current user status and vacation balance
Create new request
Enter request info 
Validate request info
IF Valid then save request and send mail to manager and redirect to VTS home.
ELSE GO To new request page to enter valid data.
ENDIF
ELSE SHOW internal home
ENDIF
ELSE SHOW Message please enter correct username and password
ENDIF
...
IF authenticated THEN
   Authorize user
IF  Authorized THEN 
 Show VTS requests which Required approval from manage
Open any request and view request details
